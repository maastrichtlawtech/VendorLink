...
parser.add_argument('--data_to_train',  type=str, default='traderoute-agora', help="""Datasets to be evaluated (can be "traderoute-agora" or "valhalla-berlusconi")""")
...
parser.add_argument('--bert_layer', type=str, default="last", help="""Bert layer to extract embeddings from. Layer can only be last, second-to-last, first, weighted-sum-last-four, all, or concat-last-4 """)
parser.add_argument('--load_model', type=str, default="../models/merged/uncased/bert/epoch_39.model", help="Loading the trained model")
parser.add_argument('--save_model_dir', type=str, default=os.path.join(os.getcwd(), "../models/knowledge-transfer/traderoute-agora/last/"), help="""Directory for models to be saved""")
