...
Description: Contains the architecture of a Character CNN architecture
"""
...
class CharacterLevelCNN(nn.Module):
    def __init__(self, n_classes=1442, input_length=512, input_dim=len(tokenizer.get_vocab()),
                 n_conv_filters=32, n_fc_neurons=768):
        ...
        if n_conv_filters == 256 and n_fc_neurons == 768:
            self._create_weights(mean=0.0, std=0.05)
        elif n_conv_filters == 1024 and n_fc_neurons == 1024:
